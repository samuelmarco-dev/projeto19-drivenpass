...
import { createCredentialUser } from "../controllers/credentialController.js";
...
credentialRouter.post('/credencial', validationSchema(schemaCredencial), validationTokenUser, createCredentialUser);
